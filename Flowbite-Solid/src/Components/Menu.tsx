export default [
    {
        'text':
            <>
                <svg fill="none" class="w-5 h-5 mr-3" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
        ...
        'children': [
            {
                'text':
                    <>
                        <svg fill="none" class="w-5 h-5 mr-3" stroke="currentColor" stroke-width="1.5"
    ...
    },
    {
        'text':
            <>
                <svg fill="none" class="w-5 h-5 mr-3" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
